...
pointLight.position.set(0, 0, 3.9);
...
let boundingBox;  // Store the bounding box
        ...
        gltfScene.traverse((child) => {
            if (child.isMesh) {
                ...
                const meshNames = ['D001', 'D002', 'D003', 'D004', 'D005', 'D006', 'D007', 'D008',
                                   ...
                                   'L025', 'L026', 'L027', 'L028', 'L029', 'L030', 'L031', 'L032'];  // Removed F001-F008
...
generateBtn.addEventListener('click', function() {
    if (modelLoaded) {
        ...
        if (boundingBox) {
            ...
            controls.maxDistance = maxDim * 2;  // Allow zooming out to twice the max dimension
        }
